...
document.querySelector(".music_playerpage_one").style.display="flex";
...
document.querySelector(".favourite__page").style.display="none"; 
document.querySelector(".music_playerpage_one").style.display="none";
...
function open_git(){
window.location.href = 'https://github.com/twinkal358';
}
